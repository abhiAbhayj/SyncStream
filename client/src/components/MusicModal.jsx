...
export default function MusicModal() {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[9999] flex flex-col justify-between bg-gradient-to-b from-[#090b16] via-[#0f142b] to-[#070812] text-white p-3 sm:p-5 md:p-6 select-none overflow-hidden animate-fade-in"
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-80 sm:w-96 h-80 sm:h-96 rounded-full bg-accentPurple/15 blur-3xl pointer-events-none animate-pulse" />
      ...
      <main className="relative z-10 max-w-3xl mx-auto w-full flex-1 min-h-0 flex flex-col items-center justify-center overflow-hidden py-1">
        ...
        {/* 2. LYRICS VIEW */}
        {modalTab === 'lyrics' && (
          <div className="w-full h-full min-h-0 flex-1 flex flex-col glass-panel rounded-2xl sm:rounded-3xl border border-white/20 p-3 sm:p-5 backdrop-blur-3xl bg-[#12162d]/95 shadow-2xl overflow-hidden animate-fade-in">
            ...
            {lyricsData.loading ? (
              ...
              <div className="flex flex-col items-center justify-center flex-1 min-h-0 text-center p-4 sm:p-6 space-y-3 my-auto">
                ...
                <div className="space-y-1 max-w-sm">
                  <h3 className="text-sm sm:text-base font-bold text-white font-outfit">{cleanText(currentTrack.title)}</h3>
                  <p className="text-xs text-gray-400">{cleanText(currentTrack.artist)}</p>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[11px] text-gray-400 truncate">{cleanText(t.artist)}</p>
                      </div>
                    </div>
      ...
      <footer className="relative z-20 max-w-xl mx-auto w-full shrink-0 space-y-2 pt-2 pb-[env(safe-area-inset-bottom,0.25rem)]">
        ...
        <div className="space-y-1 px-1">
          ...
          >
            ...
            />
            <div
              className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-3.5 h-3.5 rounded-full bg-white shadow-[0_0_10px_#fff]"
        ...
        <div className="hidden sm:flex items-center justify-center gap-2.5 pt-1">
          ...
          <input
            ...
            className="w-24 sm:w-28 h-1.5 bg-white/20 rounded-lg appearance-none cursor-pointer accent-accentCyan"
          />
        </div>
