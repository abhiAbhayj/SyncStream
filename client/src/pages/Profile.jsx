...
const THEME_OPTIONS = [
  {
    id: 'ocean',
    name: '🌊 Mariana Bioluminescent Abyss',
    desc: 'Deep oceanic trench, pulsing siphonophore jellyfish & hydro energy ripples',
    animation: 'Bioluminescent jellyfish & hydro ripples',
    swatch: ['#030b14', '#00f5d4', '#7b2cbf', '#e0fbfc'],
  },
  {
    id: 'inferno',
    name: '🔥 Molten Obsidian Forge',
    desc: 'Volcanic basalt crucible, viscous fluid magma waves & heated embers',
    animation: 'Viscous magma surges & ember sparks',
    swatch: ['#0d0707', '#ff9e00', '#d00000', '#ffea00'],
  },
  {
    id: 'matrix',
    name: '⚡ Quantum Cyberverse',
    desc: 'Quantum void, 3D hyperspace warp-speed starlines & warp rings',
    animation: '3D hyperspace warp & quantum rings',
    swatch: ['#040a07', '#00ff88', '#4cc9f0', '#f72585'],
  },
  {
    id: 'monochrome',
    name: '⚪ Lunar Monolith Noir',
    desc: 'Pitch architectural noir, liquid mercury waves & coordinate reticles',
    animation: 'Liquid mercury & coordinate reticles',
    swatch: ['#060608', '#f8fafc', '#cbd5e1', '#94a3b8'],
  },
  {
    id: 'arctic',
    name: '❄️ Nordic Aurora Glacialis',
    desc: 'Nordic polar midnight, curving multi-spectral aurora & frost needles',
    animation: 'Northern lights aurora & frost dust',
    swatch: ['#040c1a', '#06d6a0', '#118ab2', '#8338ec'],
  },
  {
    id: 'tokyo',
    name: '🌸 Cyber Neon Glitch',
    desc: 'Carbon glitch void, cyberpunk HUD audio spectrum bars & CRT scanlines',
    animation: 'HUD audio visualizer & glitch scanlines',
    swatch: ['#08080c', '#00f0ff', '#ff0055', '#ffe600'],
  },
  {
    id: 'cyber',
    name: '👑 Royal 24K Solar Mirage',
    desc: 'Imperial onyx bronze, volumetric golden sunbeams & 3D diamond starbursts',
    animation: 'Volumetric sunbeams & diamond starbursts',
    swatch: ['#0f0d08', '#ffd000', '#b37d14', '#fff2b2'],
  },
  {
    id: 'amethyst',
    name: '🌌 Event Horizon Singularity',
    desc: 'Deep space void, black hole accretion disk & relativistic photon rings',
    animation: 'Black hole accretion disk & photon lensing',
    swatch: ['#040209', '#ff9f1c', '#7b2cbf', '#48cae4'],
  },
];
