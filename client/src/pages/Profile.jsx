...
const THEME_OPTIONS = [
  {
    id: 'ocean',
    name: '🎬 Cinematic OLED',
    desc: 'Vantablack (#000000) & Charcoal (#18181B) with Crimson Red (#E50914) & Muted Silver (#D4D4D8)',
    animation: 'Theater Dimming & Focus Pop',
    swatch: ['#000000', '#18181B', '#E50914', '#D4D4D8'],
  },
  {
    id: 'arctic',
    name: '🧊 Glassmorphic Slate',
    desc: 'Deep Slate (#0F172A) & Frosted Glass with Ice Blue (#38BDF8) & Crisp White (#F8FAFC)',
    animation: 'Reflective Light Sweep & Frosted Panes',
    swatch: ['#0F172A', '#1E293B', '#38BDF8', '#F8FAFC'],
  },
  {
    id: 'inferno',
    name: '🎨 Anime Ink & Cell',
    desc: 'Paper White (#FAFAFA) & Graphite (#18181B) with Vibrant Coral (#FF4550) & Cell-shade Blue (#1E3A8A)',
    animation: 'Manga Panel Snap & Ink Motes',
    swatch: ['#FAFAFA', '#18181B', '#FF4550', '#1E3A8A'],
  },
  {
    id: 'amethyst',
    name: '🌌 Acoustic Aurora',
    desc: 'Deep Space (#050517) & Midnight (#171923) with Neon Teal (#2DD4BF) & Soft Lavender (#E0E7FF)',
    animation: 'Fluid Mesh Gradient & Acoustic Waves',
    swatch: ['#050517', '#171923', '#2DD4BF', '#E0E7FF'],
  },
  {
    id: 'matrix',
    name: '⚡ Monochrome Quantum',
    desc: 'True Black (#000000) & Dark Ash (#27272A) with Laser Green (#10B981) & Pure White (#FFFFFF)',
    animation: 'Typographic Glitch & Quantum Grid',
    swatch: ['#000000', '#27272A', '#10B981', '#FFFFFF'],
  },
  {
    id: 'cyber',
    name: '👑 Premium Gold Luxe',
    desc: 'Obsidian (#0A0A0A) & Matte Gunmetal (#3F3F46) with Brushed Gold (#D4AF37) & Ivory (#FFFFF0)',
    animation: 'Elegant Elevation & 24K Gold Dust',
    swatch: ['#0A0A0A', '#3F3F46', '#D4AF37', '#FFFFF0'],
  },
  {
    id: 'tokyo',
    name: '🪩 Vibrant Synth',
    desc: 'Deep Navy (#0A192F) & Ocean Blue (#112240) with Magenta Pop (#D53F8C) & Cyan Glow (#64FFDA)',
    animation: 'Ambient Heartbeat Pulse & Synth Waves',
    swatch: ['#0A192F', '#112240', '#D53F8C', '#64FFDA'],
  },
  {
    id: 'monochrome',
    name: '🏛️ Studio Minimal',
    desc: 'Warm Sand (#F7FAFC) & Pure White (#FFFFFF) with Sunset Orange (#DD6B20) & Forest Slate (#2D3748)',
    animation: 'Magnetic Attraction & Kinetic Currents',
    swatch: ['#F7FAFC', '#FFFFFF', '#DD6B20', '#2D3748'],
  },
];
