...
const THEME_OPTIONS = [
  {
    id: 'ocean',
    name: '⚔️ Cyber-Ronin (Anime Focus)',
    desc: 'Void black, carbon & neon blood red with Katana Slice reveal physics',
    animation: 'Katana slice reveal & cyber sparks',
    swatch: ['#0A0A0C', '#18181C', '#FF003C', '#00F0FF'],
  },
  {
    id: 'monochrome',
    name: '⚪ Graphite Sketch (Manga Focus)',
    desc: 'Pitch & graphite charcoal with Pencil-to-Color paint mask transition',
    animation: 'Pencil-to-color mask & ink wash',
    swatch: ['#090909', '#121212', '#F5F5F5', '#404040'],
  },
  {
    id: 'inferno',
    name: '🌊 Abyssal Fluid (Movie Focus)',
    desc: 'Deep trench & bioluminescent cyan with SVG water-ripple displacement',
    animation: 'SVG displacement water ripple & caustics',
    swatch: ['#020617', '#0F172A', '#06B6D4', '#3B82F6'],
  },
  {
    id: 'amethyst',
    name: '🎵 Midnight Vinyl (Music Focus)',
    desc: 'OLED black & ultraviolet with isometric 3D unfold and spinning vinyl',
    animation: 'Isometric 3D unfold & vinyl grooves',
    swatch: ['#000000', '#18181B', '#8B5CF6', '#D946EF'],
  },
  {
    id: 'arctic',
    name: '❄️ Oxygen Glare (Modern UI)',
    desc: 'Obsidian & smoked glass with dynamic cursor 3D tilt & flashlight glare',
    animation: 'Dynamic cursor tilt & light glare',
    swatch: ['#050505', '#18181A', '#F97316', '#14B8A6'],
  },
  {
    id: 'tokyo',
    name: '👾 CRT Arcade (Action Series)',
    desc: 'CRT off & deep purple with chromatic aberration RGB channel split & scanlines',
    animation: 'Chromatic aberration & CRT scanlines',
    swatch: ['#050505', '#130024', '#39FF14', '#FF00FF'],
  },
  {
    id: 'cyber',
    name: '👑 Velvet Eclipse (Premium Focus)',
    desc: 'Vantablack & aged gold with luxurious mouse spotlight flashlight mask',
    animation: 'Luxurious mouse spotlight & corona',
    swatch: ['#0A0A0A', '#1C1917', '#D4AF37', '#991B1B'],
  },
  {
    id: 'matrix',
    name: '⚡ Neon Matrix (Sci-Fi/Tech)',
    desc: 'Terminal void & dark phosphor with cascading digital data rain hover',
    animation: 'Cascading digital rain & sharp focus',
    swatch: ['#000501', '#011A0B', '#00FF41', '#008F11'],
  },
];
